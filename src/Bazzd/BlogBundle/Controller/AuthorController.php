...
namespace Bazzd\BlogBundle\Controller;
...
use Bazzd\BlogBundle\Entity\Author;
use Bazzd\BlogBundle\Form\AuthorType;
...
class AuthorController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('BazzdBlogBundle:Author')->findAll();
     ...
     * @Method("POST")
     * @Template("BazzdBlogBundle:Author:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BazzdBlogBundle:Author')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("BazzdBlogBundle:Author:edit.html.twig")
     */
